...
<div id="heading" style="padding: 4rem 0;" class="color-bg">
    <div class="fw-wrapper" style="text-align:center;">
        <h1>Cordell &amp; Cordell <?php echo single_cat_title(); ?></h1>
    </div>
</div>
					...
					<div style="padding: 10px;">
						<div class="image center" style="text-align: center;">
							...
							if ( has_post_thumbnail()) {
							   the_post_thumbnail('landscape-600');
							} else { 
								echo '<img src="' . get_template_directory_uri() . '/images/featured-image.jpg" alt="Cordell Logo">';
							}
							?>
							</a>
						</div>
						<div style="margin: 20px 0;">
							...
							<div class="flex-row-center no-phones" style="font-size: 1rem;font-weight: 600;">
								<a href="<?php the_permalink(); ?>" tabindex="-1">Read More</a>
